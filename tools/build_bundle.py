...
BUNDLE_FILES = [
    ...
    "secmeli_resmi.js",          # uiComponents.js'ten ÖNCE (meslekî kurumların resmî seçmeli listeleri)
...
if (typeof window !== 'undefined') {
    ...
    if (typeof SECMELI_RESMI !== 'undefined') window.SECMELI_RESMI = SECMELI_RESMI;
